$(document).ready(function(){
	...
	var Tabs = {
		'Overview': 'tabs/portfolio.php',	
		'Portfolio': 'tabs/portfolio.php',
		'Reel':     'tabs/reel.php',
		'Curriculum':         'tabs/curriculum.php',
	}
	...
	$.each(Tabs,function(i,j){
		...
		var tmp = $('<li><a href="#" class="tab orange">'+i+' </a></li>');
	...
	the_tabs.click(function(e){
		...
		{	
			...
			$('#contentHolder').html('<img src="img/ajax_preloader.gif" width="32" height="32" class="preloader" />');
