...
<body>
	<div class="cont">
		...
		<div class="clearfix"></div>
		<h2>By the city</h2>
		<div class="cont_map"></div><!--end cont_map-->
		<div class="cont_galleries_list">
			<h4>BUENOS AIRES</h4>
			<a href="" class="calendar">CALENDAR</a>
			<div class="box_gallery">
				<img src="img/img_gallery.jpg" alt=""/>
				<div class="gallery_info">
					<h3><a href="">Erwin Wurm</a></h3>	
					<p>Samurai & Zorro
					August 31, 2012 - October 31, 2012 </p>
				</div>
			</div><!--end box_gallery-->
			<div class="box_gallery">
				<img src="img/img_gallery.jpg" alt=""/>
			...
			<div class="clearfix"></div>			
			<div class="v_m"><a class="">VIEW MORE</a></div> 	
		</div><!--end gallery_city-->
