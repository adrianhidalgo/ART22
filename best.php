...
<body>
	<div class="cont">
		...
		<div class="clearfix"></div>
		<div class="cont_ttl">
			<h3>The best of week</h3>
			<div class="line_color"></div>	
		</div>
		<ul class="galleries">
			<li><a href="">ASIATIC ARTE</a></li>
			<li><a href="">ATRIL GALERIA DE ARTE </a></li>
			<li><a href="">ATRIL GALERIA DE ARTE </a></li>
			<li><a href="">ASIATIC ARTE</a></li>
			<li><a href="">ATRIL GALERIA DE ARTE </a></li>
			<li><a href="">ASIATIC ARTE</a></li>			
		</ul>
			<div class="cont_gallery_desc">
				<img src="img/best1.jpg" alt="" />
				<div class="title"><p>The Joan Miró Foundation, Barcelona<br/>
				<span>22.06. – 24.09.2012</span></p></div>
			</div><div class="clearfix"></div>
				<div class="cont_address">
					<img class="q_small" src="img/quote_small.png" alt="" />
					<address>11 West 53 Street  New York,<br/> 
						555 W 24th St, New York<br/> 
						<span> +1 212-741-1111</span>
					</address>
					 <img class="q_big" src="img/quote_big.png" alt="" />
				</div>
