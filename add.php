...
<body>
	<div class="cont">
		...
		<div class="cont_left">
			<p class="add_text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, <strong>when an unknown printer</strong> took a galley of type and scrambled it to make a type specimen book.
			</p>
			<label>Name</label>
			<input type="text" size="30/" name="NOMBRE"><div class="clearfix"></div>
			<label>Email</label>
